import { APIBaseSelectMenuComponent, APIButtonComponentBase, APIMessageComponentEmoji, ButtonStyle, ComponentType } from "@discordjs/core";
import { _Omit } from "../types";
import { resolvePartialEmoji } from "../utils";



export class BaseSelectMenuBuilder<T extends ComponentType.StringSelect | ComponentType.UserSelect | ComponentType.RoleSelect | ComponentType.MentionableSelect | ComponentType.ChannelSelect> implements APIBaseSelectMenuComponent<T>{
...
export class BaseButtonBuilder<T extends ButtonStyle> implements APIButtonComponentBase<T> {
    ...
    setStyle(style: T | "Primary" | "Secondary" | "Success" | "Danger" | "Link"){
        ...
        this.style = (typeof style === "string" ? stylesMap[style] || ButtonStyle.Primary : style) as T;
        return this;
    };
